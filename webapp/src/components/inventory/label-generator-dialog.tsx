...
export function LabelGeneratorDialog({ open, onOpenChange, target, targetType }: LabelGeneratorDialogProps) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
             ...
             <Select value={format} onValueChange={(val) => { setFormat(val); setGeneratedSvg(null); }}>
               <SelectTrigger className="col-span-3">
                 <SelectValue />
               </SelectTrigger>
               <SelectContent>
                 <SelectItem value="shipping-4x6">Shipping (4&quot; x 6&quot;)</SelectItem>
                 <SelectItem value="address-30x100">Address (30mm x 100mm)</SelectItem>
          ...
          <div className="flex justify-center min-h-[200px] border rounded bg-gray-50 items-center overflow-hidden p-4">
             {isGenerating ? (
               ...
               <div dangerouslySetInnerHTML={{ __html: generatedSvg }} className="max-h-[300px] max-w-full shadow-lg bg-white" />
             ) : (
               <div className="text-sm text-gray-400">Select format and generate preview</div>
             )}
          </div>
        </div>
        <DialogFooter className="sm:justify-between">
           ...
           <div className="flex gap-2">
             ...
             <Button onClick={handlePrint} disabled={!generatedSvg} variant="default">
